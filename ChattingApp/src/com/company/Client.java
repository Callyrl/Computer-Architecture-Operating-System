...
public class Client extends Thread
{
    ...
    private void loginHandling(OutputStream output, String[] tokens) throws IOException {
        if(tokens.length == 3)
        {
            ...
            if(username.equals("guest") && password.equals("guest") || username.equals("cally") && password.equals("iloverachel") || username.equals("rachel") && password.equals("aimeeforlife") || username.equals("aimee") && password.equals("cally4ever"))
            {
